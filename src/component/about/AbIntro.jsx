        ...
        <div className='w-full gap-3 lg:py-16 md:py-8 py-4 lg:px-20 md:px-10 px-5 dark:bg-white dark:text-black'>
            <div className='sm:pr-10 text-black'>
                ...
                <div className='space-y-16 lg:space-y-24'>
                    ...
                    <div className='mt-16'>
                        <h1 className="font-bold text-2xl lg:text-4xl leading-tight">Core Values</h1>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-4">
                                <h2 className='font-bold mb-5 text-xl'>Beyond Aesthetics</h2>
                                <p className="text-sm lg:text-base leading-7 text-gray-700">"We don't build pretty. We build purposeful.</p>
                                <p className="text-sm lg:text-base leading-7 text-gray-700">Every block has a reason. Every space is designed to guide the player, not just impress them. We apply architectural theory to Minecraft — because a beautiful world that confuses its player has failed its purpose."</p>
                            </div>

                            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-4">
                                <h2 className='font-bold mb-5 text-xl'>Solution Driven</h2>
                                <p className="text-sm lg:text-base leading-7 text-gray-700">We don't just build what you ask for.</p>
                                <p className="text-sm lg:text-base leading-7 text-gray-700">We question your pain point first — what problem does this space need to solve? Then we design backwards from the answer. Our clients don't just get a build. They get a solution."</p>
                            </div>

                            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-4">
                                <h2 className='font-bold mb-5 text-xl'>Limitless Creativity</h2>
                                <p className="text-sm lg:text-base leading-7 text-gray-700">"The moment you say 'that's impossible in Minecraft' — that's where challange begin.</p>
                                <p className="text-sm lg:text-base leading-7 text-gray-700">We don't chase trends. We set them. Inspired by the essence of every dreamer who ever placed their first block, we push what's possible — technically, creatively, and narratively."</p>
                            </div>
                        </div>
                    </div>
