        ...
        <section id='tentang'>
            <div className='w-full md:grid md:grid-cols-2 gap-3 lg:py-16 md:py-8 py-4 lg:px-20 md:px-10 px-5'>
                <div className='pr-10'>
                    ...
                    {/* <p className='font-sans lg:text-lg md:text-xs text-sm text-justify'>We don’t just build, we design virtual environments that reflect the unique identity of your community. We create functional spaces, timeless memories, and a sense of belonging for every member.</p> */}
                    ...
                    <button className="w-full lg:w-96 block mt-8 items-center gap-3 bg-[#00AEEF] hover:bg-sky-600 px-10 py-2 text-[#FEF7E7] text-lg font-semibold rounded-lg">
