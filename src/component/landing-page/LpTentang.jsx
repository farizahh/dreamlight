        ...
        <section id='tentang'>
            <div className='w-full md:grid md:grid-cols-2 gap-3 lg:py-16 md:py-8 py-4 lg:px-20 md:px-10 px-5 dark:bg-white dark:text-black text-black'>
                <div className='pr-10'>
                    ...
                    <button className="w-full block mt-7 2xl:mt-10 items-center gap-3 bg-[#00AEEF] hover:bg-sky-600 px-10 py-2 text-[#FEF7E7] text-lg 2xl:text-2xl font-semibold rounded-lg">
