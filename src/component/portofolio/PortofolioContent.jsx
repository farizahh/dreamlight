...
const PortfolioContent = () => {
  return (
    <section id='portofolio-content'>
      <div className='w-full lg:py-10 md:py-8 py-8 lg:px-20 md:px-10 px-5 dark:bg-white dark:text-black'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-10'>
          {portfolios.map((item) => (
            <div key={item.id} className="card bg-base-100 w-full shadow-sm border-[#E4E4E7] dark:bg-white border hover:shadow-lg transition">
              <figure>
